<template>
	<div id="home-content">
		...
		<div class="mb-4">
			In order to perform actions to edit data on the site you will need to sign
			in as one of the random users. To do this select the username for the user
			you choose and the password noted on the dialog.
		</div>

		<div class="mb-4">
			Construction of this site used the component based framework
			<a href="https://nuxt.com/">Nuxt</a> and the CSS framework
			<a href="https://tailwindcss.com/" target="_blank">Tailwind CSS.</a> The
			...
			was made not to reinvent the wheel.
		</div>

		<div class="mb-4">
			This site is one of four front end sites that share a common back end api.
			The front end sites are composed using the frameworks:
			<ul>
